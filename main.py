...
history = np.savez(args.dataset + '_' + str(args.valid_size) + '_standard_history', train_loss=train_loss_his, valid_loss=valid_loss_his, test_loss=test_loss_his,
                   train_acc=train_acc_his, valid_acc=valid_acc_his, test_acc=test_acc_his)